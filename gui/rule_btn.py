...
class RuleButtonBase(tk.Button):
    def __init__(self, master,log,table, **kwargs):
...
class AddRuleButton(RuleButtonBase):
    def __init__(self, master,log: LogText,table, **kwargs):
        super().__init__(master,log,table, **kwargs)
